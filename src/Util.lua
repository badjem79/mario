...
function GenerateQuads(atlas, tilewidth, tileheight, startWidth, startHeight)
    local sheetWidth = atlas:getWidth() / tilewidth
    local sheetHeight = atlas:getHeight() / tileheight
    startWidth = startWidth or 0
    startHeight = startHeight or 0

    local sheetCounter = 1
    local spritesheet = {}

    for y = (startHeight/tileheight), sheetHeight - 1 do
        for x = (startWidth/tilewidth), sheetWidth - 1 do
